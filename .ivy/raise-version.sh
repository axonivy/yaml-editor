...
mvn --batch-mode -f playwright/projects/connector/pom.xml versions:set versions:commit -DnewVersion=${1}
mvn --batch-mode -f playwright/projects/variables-test-project/pom.xml versions:set versions:commit -DnewVersion=${1}
